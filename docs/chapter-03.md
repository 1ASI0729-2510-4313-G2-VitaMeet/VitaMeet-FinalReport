...
| US05 | Cerrar sesión | Como usuario del segmento objetivo médico/paciente Quiero cerrar sesión Para proteger mi cuenta cuando termine de usar la aplicación. | Escenario : Cierre de sesión exitoso <br> Dado que soy un médico/paciente de la aplicación Cuando hago clic en el botón "Cerrar sesión" Entonces debería ser desconectado de mi cuenta y redirigido a la página de inicio. | EP01 | 
| US06 | Editar datos del usuario | Como usuario registrado del segmento objetivo médico/paciente  Quiero editar mis datos personales Para mantener mi información actualizada. | Escenario : Editar datos del usuario <br> Dado que soy un médico/paciente Cuando edito mis datos personales y hago clic en "Guardar cambios" Entonces mis datos se actualizan correctamente en la plataforma.| EP01 | 
| US07 | Eliminar cuenta | Como usuario del segmento objetivo médico/paciente Quiero eliminar mi cuenta Para dejar de utilizar la plataforma. | Escenario : Cuenta eliminada <br> Dado que soy un médico/paciente Cuando solicito eliminar mi cuenta Entonces se me solicita una confirmación y mi cuenta se elimina de la plataforma tras confirmar. | EP01 |
...
|---------|---------------|------------------------------------------|---------------------------------------------------------------------------------------------------------------------|----------------------------------|
| 1       | US01          | Registrar usuario                       | Como visitante Quiero registrar mi cuenta Para hacer uso de la aplicación.                                          | 1                                |
| 2       | US02          | Confirmación de registro de cuenta      | Como usuario Quiero recibir una confirmación al registrar mi cuenta Para saber que el proceso se completó correctamente. | 1                                |
| 3       | US05          | Cerrar sesión                           | Como usuario Quiero cerrar sesión Para proteger mi cuenta cuando termine de usar la aplicación.                    | 1                                |
| 4       | US16          | Navegación por el Landing Page          | Como visitante Quiero navegar por la landing page del software Para obtener la información que deseo del producto.    | 1                                |
| 5       | US17          | Acceder a la aplicación desde la landing page | Como visitante de la página Quiero poder acceder a la aplicación desde la landing page Para empezar a usarla.       | 1                                |
| 6       | US08          | Filtrar búsqueda de médicos              | Como paciente Quiero filtrar la búsqueda de médicos por disponibilidad Para facilitar la elección.                 | 2                                |
| 7       | US09          | Ver información del médico              | Como paciente Quiero ver los detalles de un médico Para tomar una decisión informada.                             | 2                                |
| 8       | US03          | Iniciar sesión                          | Como usuario registrado Quiero iniciar sesión Para acceder a mi cuenta.                                          | 2                                |
| 9       | US18          | Cancelar cita médica                    | Como paciente Quiero poder cancelar una cita médica si no puedo asistir para liberar el espacio para otro paciente. | 3                                |
| 10      | US04          | Restablecer contraseña                  | Como usuario Quiero restablecer mi contraseña si la olvido Para poder acceder a mi cuenta.                         | 3                                |
| 11      | TS15          | Cambiar el Idioma de la Landing Page    | Como visitante Quiero cambiar el idioma de la landing page Para poder entender mejor la información presentada.    | 3                                |
| 12      | US12          | Agendar Cita Médica                     | Como paciente Quiero poder separar o agendar una cita con un médico cuando elijo una fecha y hora disponibles       | 5                                |
| 13      | US06          | Editar datos del usuario                | Como usuario registrado Quiero editar mis datos personales Para mantener mi información actualizada.               | 5                                |
| 14      | US07          | Eliminar cuenta                         | Como usuario Quiero eliminar mi cuenta Para dejar de utilizar la plataforma.                                        | 5                                |
| 15      | US10          | Pagar la cita                           | Como paciente Quiero pagar mi cita médica Para confirmar mi asistencia.                                          | 5                                |
| 16      | US15          | Dejar una reseña sobre un médico        | Como paciente Quiero poder dejar una reseña sobre un médico después de una cita Para compartir mi experiencia       | 5                                |
| 17      | US13          | Ver historial de pacientes atendidos    | Como médico Quiero ver el historial de los pacientes atendidos Para un mejor seguimiento de su tratamiento.         | 5                                |
| 18      | US14          | Acceder al historial médico del paciente | Como médico Quiero acceder al historial médico de mis pacientes Para ofrecer una atención más adecuada.            | 5                                |
| 19      | TS19          | Contactar al Equipo de Soporte          | Como visitante Quiero contactar al equipo de soporte Para obtener ayuda o resolver dudas sobre la plataforma.      | 8                               |
